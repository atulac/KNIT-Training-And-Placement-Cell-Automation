...
db = MySQLdb.connect("localhost","root","","SECOND_YEAR")
...
cursor.execute("DROP TABLE IF EXISTS DETAILED,BRANCH_CHANGERS,GRADE_STATUS,PRECISE,UFM")
...
for i in range(t):
    ...
    if year==2:
        SecondYear.execute(Details,branch,Branch_Switchers)
...
print "==============================================================================CARRY OVER DETAILS DATABASE============================================================================="
