...
t=PrettyTable(["ROLL","NAME","FATHER_NAME","SEM1","SEM2","PENDING1","STATUS1","SEM1_CO","SEM2_CO","PENDING1_CO","STATUS1_CO","SEM3","SEM4","PENDING2","STATUS2"])
def execute(Details,url,rolls):
    ...
    for ROLL in Range.RollRange[rolls]:
        ...
        #           Details[ROLL]["SEM4"],Details[ROLL]["PENDING2"],Details[ROLL]["STATUS2"]])

    #print t


    print "EVEN 14_15 DONE"
